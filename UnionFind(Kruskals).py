...
class UnionFind:
    ...
    def UFJoin(self, node1, node2):
        if self.parents[node1] != self.parents[node2]:
            parenta = self.UFFind(node1)
            parentb = self.UFFind(node2)
...
edges4 = [(4, 5, 2), (0, 1, 3), (3, 5, 3), (1, 2, 4), (5, 6, 4), (1, 6, 5), (3, 4, 5), (2, 3, 6), (2, 5, 6), (0, 2, 7), (4, 6, 7), (1, 3, 8), (3, 6, 8), (2, 4, 9), (0, 5, 10)]
# fmt: off
edges5 = [(0, 1, 1), (1, 2, 2), (2, 3, 3), (3, 4, 2), (4, 5, 1), (0, 2, 4), (1, 3, 5), (2, 4, 6), (3, 5, 4), (0, 4, 7), (1, 5, 8), (2, 5, 9), (0, 3, 10), (1, 4, 3)]
# fmt: on
edges5 = [
    (0, 1, 1),
    (1, 2, 2),
